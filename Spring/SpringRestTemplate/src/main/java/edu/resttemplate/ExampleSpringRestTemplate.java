 ...
 */
public class ExampleSpringRestTemplate {
    private static final Logger log= LoggerFactory.getLogger(ExampleSpringRestTemplate.class);
    private static final String URL_GET_ALL_CONTACTS="http://localhost:8080/SpringRestTemplate/restful/contact/listData";
    private static final String URL_GET_CONTACT_BY_ID="http://localhost:8080/SpringRestTemplate/restful/contact/{id}";
    private static final String URL_CREATE_CONTACT="http://localhost:8080/SpringRestTemplate/restful/contact/";
    private static final String URL_UPDATE_CONTACT="http://localhost:8080/SpringRestTemplate/restful/contact/{id}";
    private static final String URL_DELETE_CONTACT="http://localhost:8080/SpringRestTemplate/restful/contact/{id}";
