package edu.restsecurity;


import edu.restsecurity.model.Contact;
import edu.restsecurity.model.Contacts;
...
public class ExampleSpringRestSecurity {
    ...
    private static final String URL_GET_ALL_CONTACTS="http://localhost:8080/SpringRestSecurity/restful/contact/listData";
    private static final String URL_GET_CONTACT_BY_ID="http://localhost:8080/SpringRestSecurity/restful/contact/{id}";
    private static final String URL_CREATE_CONTACT="http://localhost:8080/SpringRestSecurity/restful/contact/";
    private static final String URL_UPDATE_CONTACT="http://localhost:8080/SpringRestSecurity/restful/contact/{id}";
    private static final String URL_DELETE_CONTACT="http://localhost:8080/SpringRestSecurity/restful/contact/{id}";
