...
CREATE SCHEMA payment_perclass;

CREATE TABLE payment_perclass.jc_payment
(
...
ALTER TABLE payment_perclass.jc_payment OWNER TO postgres;


CREATE TABLE payment_perclass.jc_cash_payment
(
  payment_id INTEGER,
...
ALTER TABLE  payment_perclass.jc_cash_payment OWNER TO postgres;

CREATE TABLE payment_perclass.jc_credit_payment
(
  payment_id INTEGER,
  amount DOUBLE PRECISION,
...
ALTER TABLE  payment_perclass.jc_credit_payment OWNER TO postgres;
--
-- insert into payment_perclass.jc_payment  (amount) values (100);
-- insert into payment_perclass.jc_credit_payment  (payment_id,credit_card ) values (5,'434485120071413');
-- insert into payment_perclass.jc_payment  (amount) values (200);
-- insert into payment_perclass.jc_credit_payment  (credit_card ) values ('554483120071420');
-- insert into payment_perclass.jc_payment  (amount) values (300);
-- insert into payment_perclass.jc_cash_payment  (cash_desk ) values ('Kassa1');


--SELECT jc_credit_payment_perclass.payment_id,credit_card,amount FROM payment_perclass.jc_credit_payment,payment_perclass.jc_payment
